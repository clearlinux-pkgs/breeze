...
Version  : 5.27.8
Release  : 95
URL      : https://download.kde.org/stable/plasma/5.27.8/breeze-5.27.8.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.8/breeze-5.27.8.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.8/breeze-5.27.8.tar.xz.sig
...
%prep
%setup -q -n breeze-5.27.8
cd %{_builddir}/breeze-5.27.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694538146
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libbreezecommon5.so.5.27.8
...
/usr/lib64/libbreezecommon5.so.5.27.8
