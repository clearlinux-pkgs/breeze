...
Version  : 6.0.0
Release  : 99
URL      : https://download.kde.org/stable/plasma/6.0.0/breeze-6.0.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.0/breeze-6.0.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.0/breeze-6.0.0.tar.xz.sig
...
%prep
%setup -q -n breeze-6.0.0
cd %{_builddir}/breeze-6.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709394194
mkdir -p clr-build
pushd clr-build
