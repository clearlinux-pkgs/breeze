...
Source0  : https://download.kde.org/stable/plasma/5.23.4/breeze-5.23.4.tar.xz
...
%prep
%setup -q -n breeze-5.23.4
cd %{_builddir}/breeze-5.23.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638353512
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/breeze-5.23.4/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/breeze/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/breeze-5.23.4/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/breeze/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/breeze-5.23.4/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/breeze/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/breeze-5.23.4/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/breeze/6091db0aead0d90182b93d3c0d09ba93d188f907
cp %{_builddir}/breeze-5.23.4/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/breeze/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/breeze-5.23.4/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/breeze/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/breeze-5.23.4/LICENSES/MIT.txt %{buildroot}/usr/share/package-licenses/breeze/a0193e3fccf86c17dc71e3f6c0ac0b535e06bea3
cp %{_builddir}/breeze-5.23.4/cursors/Breeze/COPYING %{buildroot}/usr/share/package-licenses/breeze/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/breeze-5.23.4/cursors/Breeze/COPYING-ICONS %{buildroot}/usr/share/package-licenses/breeze/4da8b3e7cf68bdf289e59afa90e3483c83bb6824
cp %{_builddir}/breeze-5.23.4/cursors/Breeze_Snow/COPYING %{buildroot}/usr/share/package-licenses/breeze/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/breeze-5.23.4/cursors/Breeze_Snow/COPYING-ICONS %{buildroot}/usr/share/package-licenses/breeze/4da8b3e7cf68bdf289e59afa90e3483c83bb6824
pushd clr-build
%make_install
popd
...
/usr/lib64/libbreezecommon5.so.5.23.4
