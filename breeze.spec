...
Source0  : https://download.kde.org/stable/plasma/5.25.4/breeze-5.25.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.25.4/breeze-5.25.4.tar.xz.sig
...
%prep
%setup -q -n breeze-5.25.4
cd %{_builddir}/breeze-5.25.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659710060
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libbreezecommon5.so.5.25.4
