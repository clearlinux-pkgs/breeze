...
Source0  : https://download.kde.org/stable/plasma/5.27.4/breeze-5.27.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.4/breeze-5.27.4.tar.xz.sig
...
%prep
%setup -q -n breeze-5.27.4
cd %{_builddir}/breeze-5.27.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680721622
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libbreezecommon5.so.5.27.4
