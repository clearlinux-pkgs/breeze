...
Version  : 5.27.9
Release  : 96
URL      : https://download.kde.org/stable/plasma/5.27.9/breeze-5.27.9.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.9/breeze-5.27.9.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.9/breeze-5.27.9.tar.xz.sig
...
%prep
%setup -q -n breeze-5.27.9
cd %{_builddir}/breeze-5.27.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698280203
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libbreezecommon5.so.5.27.9
...
/usr/lib64/libbreezecommon5.so.5.27.9
